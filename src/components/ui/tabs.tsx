...
const TabsList = React.forwardRef<HTMLDivElement, TabsPrimitive.List.Props & { variant?: "default" | "line" }>(
  ({ className, variant = "default", ...props }, ref) => {
    return (
      <TabsPrimitive.List
        ...
        className={cn(tabsListVariants({ variant: variant as "default" }), className)}
        {...props}
      />
    )
  }
